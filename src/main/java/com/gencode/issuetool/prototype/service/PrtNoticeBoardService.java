...
import com.gencode.issuetool.prototype.dao.PrtNoticeBoardDao;
...
import com.gencode.issuetool.prototype.storage.PrtAttachFileSystemStorageService;
import com.gencode.issuetool.prototype.storage.PrtEmbedFileSystemStorageService;
import com.gencode.issuetool.prototype.dao.PrtBoardCommentDao;
import com.gencode.issuetool.prototype.dao.PrtFileInfoDao;
import com.gencode.issuetool.prototype.dao.PrtFileReferenceDao;
...
@Service
public class PrtNoticeBoardService {
	private final static Logger logger = LoggerFactory.getLogger(PrtNoticeBoardService.class);

	@Autowired
	private PrtNoticeBoardDao noticeBoardDao;
	@Autowired
	private PrtBoardCommentDao boardCommentDao;
	@Autowired
	private PrtFileInfoDao fileInfoDao;
	@Autowired
	private PrtFileReferenceDao fileReferenceDao;
	
	@Autowired
	private PrtEmbedFileSystemStorageService embedFileService;
	@Autowired
	private PrtAttachFileSystemStorageService attachFileService;
