...
import com.gencode.issuetool.prototype.storage.PrtProfileImgStorageService;

@Service
public class PrtUserProfileService {
	private final static Logger logger = LoggerFactory.getLogger(PrtUserProfileService.class);

	@Autowired
	private PrtUserInfoDao userInfoDao;
	@Autowired
	...
	@Autowired
	private PrtProfileImgStorageService profileImgStorageService;
