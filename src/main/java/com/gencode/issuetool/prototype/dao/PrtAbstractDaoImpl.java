...
abstract public class PrtAbstractDaoImpl<T> implements PrtAbstractDao<T> {

	protected final static Logger logger = LoggerFactory.getLogger(PrtAbstractDaoImpl.class);
	protected final JdbcTemplate jdbcTemplate;
	protected final NamedParameterJdbcTemplate namedParameterJdbcTemplate;
	
	PrtAbstractDaoImpl(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
