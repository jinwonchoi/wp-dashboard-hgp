...
@Service
public class PrtFileSystemStorageService {

	private final static Logger logger = LoggerFactory.getLogger(PrtFileSystemStorageService.class);
	...
	public PrtFileSystemStorageService() {
	}
