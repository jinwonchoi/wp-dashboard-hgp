...
import com.gencode.issuetool.prototype.service.PrtUserAccountService;
import com.gencode.issuetool.prototype.service.PrtUserProfileService;
...
public class ProtoUserController {
	...
	private final static Logger logger = LoggerFactory.getLogger(ProtoUserController.class);
	
	@Autowired
	private PrtUserProfileService userProfileService;
	
	@Autowired
	private PrtUserAccountService userAccountService;
