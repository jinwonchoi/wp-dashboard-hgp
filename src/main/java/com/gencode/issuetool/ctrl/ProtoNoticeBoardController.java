...
import com.gencode.issuetool.prototype.service.PrtNoticeBoardService;

@RestController
@RequestMapping("/prototype/notice-board")
@CrossOrigin(origins = "${cors_url}")
public class ProtoNoticeBoardController {

	private final static Logger logger = LoggerFactory.getLogger(ProtoNoticeBoardController.class);
	@Autowired
	private PrtNoticeBoardService noticeBoardService;
