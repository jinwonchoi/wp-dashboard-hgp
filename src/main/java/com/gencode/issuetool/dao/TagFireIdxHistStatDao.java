...
public interface TagFireIdxHistStatDao extends Dao<TagFireIdxHistStat> {
	int[] register(List<TagFireIdxHistStat> t);
	/** 4. 분단위 등록
		4.1. 분단위 등록시 기존등록 삭제
		hst테이블=>stat테이블
	 */
	...
	*/
	 ...
	 * @return
	 */
	Optional<List<TagFireIdxHistStat>> getStatsCnt(PageRequest req);
	/**
	 * 기간별 최근 30건 
	 * @param map
	 * @return
