...
public enum Constant {
	...
	DASHBOARD_STATS_TIME_MODE_10SEC("10S"),
	...
	IOT_CRITICAL_SMOKE(100),//100%이상이면 화재
	IOT_CRITICAL_TEMP(64),//온도 64도 이상이면 화재
	IOT_CRITICAL_CO(20), //일산화탄소 20ppm이상이면 화재
	...
	DASHBOARD_LOGPRESSO_REFRESH_TIME("10s"), //10초
